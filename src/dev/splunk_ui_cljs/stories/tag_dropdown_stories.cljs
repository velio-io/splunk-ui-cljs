...
(defn ^:export tag-dropdown-error [args]
  (let [model (r/atom #{})]
    (r/as-element
     [:> SplunkThemeProvider {:family "prisma" :colorScheme "light"}
      [dropdown/tag-dropdown {:on-change #(reset! model %)
                              :model     model
                              :choices   [{:id "first" :label "First"}
...
(defn ^:export tag-dropdown-compact [args]
  (let [model (r/atom #{})]
    (r/as-element
     [:> SplunkThemeProvider {:family "prisma" :colorScheme "light"}
      [dropdown/tag-dropdown {:on-change #(reset! model %)
...
(defn ^:export tag-dropdown-filter [args]
  (let [model (r/atom #{})]
    (r/as-element
     [:> SplunkThemeProvider {:family "prisma" :colorScheme "light"}
      [dropdown/tag-dropdown {:on-change   #(reset! model %)
...
(defn ^:export tag-dropdown-inline [args]
  (let [model (r/atom #{})]
    (r/as-element
     [:> SplunkThemeProvider {:family "prisma" :colorScheme "light"}
      [dropdown/tag-dropdown {:on-change   #(reset! model %)
